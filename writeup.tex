...
\newcommand\yourname{Nely Jimenez, David Snyder} % <-- your name
\newcommand\login{Hopkins ID: 38C8F8, <NELY ID>}       
...
\noindent \emph{Homework Notes:} Each section of the assignment represents roughly equal contribution by both David Snyder and Nely Jimenez. \\
\begin{answer}{1a}
...
\[
N(\mathbf{w} \mid \mathbf{w}_{0}, \mathbf{ {\Sigma}_{0}} ) N( \mathbf{Y} \mid \mathbf{{Xw}}, {\sigma}^{2} \mathbf{I}_{n}) = N(\mathbf{w} \mid \mathbf{w}_{n}, \mathbf{\Sigma}_{n})
\]
