...
%  \end{align*}
%\end{proof}
\newcommand{\gammasumwbeta}{\Gamma( \sum_w \beta)}                % gamm sum w beta
...
\newcommand{\gammasumkalpha}{\Gamma(\sum_k \alpha)} %gamma sum k alpha
...
= \prod_k { \frac{\gammasumwbeta}{\gammesumwnkwplusbeta} \prod_w{\frac{\gammankwplusbeta}{\Gamma(\beta)}}} \prod_c \prod_k {\frac{\gammasumbeta}{\gammesumwnckwplusbeta} \prod_w{\frac{\gammanckwplusbeta}{\Gamma(\beta)}}} \prod_d{\frac{a}{b} \prod_k{\frac{a}{b}}} \prod_{d,i}P(x_{di} \mid \lambda)
\end{align*}
\end{proof}
